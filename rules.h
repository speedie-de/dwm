...
static const Rule rules[]                     = {
        ...
        { TERMINAL_CLASS,       NULL,       "dwm",                            0,          0,            0,           1,          0,             -1,          0,                 0  },
        { TERMINAL_CLASS,       NULL,       MIXER,                            0,          1,            0,           1,          1,             -1,          0,                 0  },
        { TERMINAL_CLASS,       NULL,       "cordless",                       0,          0,            0,           0,          1,             -1,          0,                 0  },
	    { BROWSER_CLASS,        NULL,       NULL,                             0,          0,            0,           1,          0,             -1,          0,                 0  },
		{ "dolphin-emu",        NULL,       NULL,                             0,          1,            1,           0,          1,             -1,          0,                 0  },
        { "mpv",                NULL,       NULL,                             0,          0,            0,           0,          0,             -1,          0,                 0  },
        { "tabbed",             NULL,       NULL,                             0,          0,            0,           0,          0,             -1,          0,                 0  },
		{ NULL,                 NULL,       "CustomizeMii 3.11 by Leathl",    0,          1,            0,           1,          1,             -1,          0,                 0  },
	    { NULL,                 NULL,       "Picture-in-Picture",             0,          1,            0,           1,          0,             -1,          0,                 0  },
	    { NULL,                 NULL,       "About GNU IceCat",               0,          1,            0,           1,          0,             -1,          0,                 0  },
	    { NULL,                 NULL,       "About LibreWolf",                0,          1,            0,           1,          0,             -1,          0,                 0  },
	    { NULL,                 NULL,       "About Mozilla Firefox",          0,          1,            0,           1,          0,             -1,          0,                 0  },
